...
public class Resistor
{
    ...
    Resistor(Color ring1Color, Color ring2Color, Color ring3Color, Color ring4Color)
    {
    ...
    public void setRing3Color(Color ring3Color)
    {
    ...
    public void setRing4Color(Color ring4Color)
    {
